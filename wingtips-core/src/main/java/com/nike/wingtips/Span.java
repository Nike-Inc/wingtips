...
public class Span {
     ...
     *  one of the provided {@link #generateRootSpanForNewTrace(String)} or {@link #generateChildSpan(String)} helper methods, or the {@link Builder} if you
     *  need more flexibility than the helper methods.
     * </p>
    ...
    protected Span() {
        this("PLACEHOLDER", null, "PLACEHOLDER", "PLACEHOLDER", false, null, -1, -1L, -1L);
    }
    ...
    private static Span fromKeyValueMap(Map<String, String> map) {
        ...
        return new Span(traceId, parentSpanId, spanId, spanName, sampleable, userId, startTimeEpochMicros, null, durationNanos);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(traceId, spanId, parentSpanId, spanName, sampleable, userId, spanStartTimeEpochMicros, durationNanos);
    }
    ...
    public static final class Builder {
        ...
        public Span build() {
            ...
            return new Span(traceId, parentSpanId, spanId, spanName, sampleable, userId, spanStartTimeEpochMicros, spanStartTimeNanos, durationNanos);
        }
    }
}
