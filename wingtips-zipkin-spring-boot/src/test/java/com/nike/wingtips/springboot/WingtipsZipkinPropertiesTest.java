...
public class WingtipsZipkinPropertiesTest {
    ...
    public void exercise_standard_getters_and_setters() {
        ...
        // localComponentNamespace getter/setter
        {
            String nonNullLocalComponentNamespace = UUID.randomUUID().toString();
            props.setLocalComponentNamespace(nonNullLocalComponentNamespace);
            assertThat(props.getLocalComponentNamespace()).isEqualTo(nonNullLocalComponentNamespace);

            props.setLocalComponentNamespace(null);
            assertThat(props.getLocalComponentNamespace()).isNull();
        }
    }
    ...
    public void shouldApplyWingtipsToZipkinLifecycleListener_works_as_expected(
        ...
        String localComponentNamespace = (localComponentNamespaceIsNull) ? null : UUID.randomUUID().toString();
